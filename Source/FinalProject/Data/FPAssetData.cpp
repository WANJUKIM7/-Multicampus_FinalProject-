...
void UFPAssetData::PreSave(FObjectPreSaveContext ObjectSaveContext)
{
...
FSoftObjectPath UFPAssetData::GetAssetPathByName(const FName& AssetName)
{
...
const FAssetSet& UFPAssetData::GetAssetSetByLabel(const FName& Label)
{
